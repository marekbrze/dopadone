...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Cobra root command at cmd/dopa/main.go with --db flag (default: ./dopa.db)
...
2. Create cmd/dopa/main.go with Cobra root command:
   - Persistent --db flag (default: ./dopa.db)
...
7. Update cmd/dopa/main.go to wire everything together
...
- Created cmd/dopa/main.go with root command, --db flag (default: ./dopa.db), and --output flag (table|json)
